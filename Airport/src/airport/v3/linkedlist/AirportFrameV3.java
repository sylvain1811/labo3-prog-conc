 ...
 *
 */
public class AirportFrameV3 extends JFrame
	{
	...
	private List<AvionV3> avionTakeOffArray;
	private List<AvionV3> avionOnAirLeaveArray;
	...
	public AirportFrameV3(int _nbPisteArr, int _nbPisteDep, int _nbPlace, int _nbAvion)
		{
		...
		avionOnAirArray = new ArrayList<AvionV3>();
		avionLandingArray = new ArrayList<AvionV3>();
		avionTermArray = new ArrayList<AvionV3>();
		avionTakeOffArray = new ArrayList<AvionV3>();
		avionOnAirLeaveArray = new ArrayList<AvionV3>();
	...
	// (3)
	public synchronized void updatePark(AvionV3 avion)
		{
	...
	private void stopAvion(boolean state)
		...
		for(AvionV3 avion:avionLandingArray)
			{
			avion.setStop(state);
			}

		for(AvionV3 avion:avionTermArray)
			{
			avion.setStop(state);
			}

		for(AvionV3 avion:avionTakeOffArray)
			{
			avion.setStop(state);
			}

		for(AvionV3 avion:avionOnAirLeaveArray)
			{
			avion.setStop(state);
			}
		}
